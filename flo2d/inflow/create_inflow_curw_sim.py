...
def prepare_inflow(inflow_file_path, start, end, discharge_id, wl_id):
    ...
    try:
        ...
        with connection.cursor() as cursor1:
            rows  = cursor1.callproc('getWL', (wl_id,))
            if rows > 0:
        ...
        # discharge_ts = process_continuous_ts(original_ts=discharge_ts, expected_start=start, filling_value=0, )
...
if __name__ == "__main__":
    ...
    try:
        ...
        if not os.path.isfile(inflow_file_path):
            ...
            prepare_inflow(inflow_file_path, start=start_time, end=end_time)
