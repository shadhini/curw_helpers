...
nohup /home/uwcc-admin/curw_rfield_extractor/gen_kelani_basin_rfield.py -m "WRF_A,WRF_C,WRF_E,WRF_SE" -v "4.0" -s evening_18hrs 2>&1 /home/uwcc-admin/curw_rfield_extractor/rfield.log"
