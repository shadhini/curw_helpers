    ...
    try:
        ...
        if end_time > (now + timedelta(days=1)):
            ...
            while timestamp <= end_time :
                ...
                if timestamp < now:
                    write_to_file('/var/www/html/wrf/{}/rfield/d03/past/{}_{}_{}_rfield.txt'.format(version, wrf_model, version, timestamp), rfield)
                else:
                    write_to_file('/var/www/html/wrf/{}/rfield/d03/future/{}_{}_{}_rfield.txt'.format(version, wrf_model, version, timestamp), rfield)
